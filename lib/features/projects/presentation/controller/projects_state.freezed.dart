...
mixin _$ProjectsState {
 ...
 Project get selectedProject; List<Project> get projects;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ProjectsState&&(identical(other.selectedProject, selectedProject) || other.selectedProject == selectedProject)&&const DeepCollectionEquality().equals(other.projects, projects));
}


@override
int get hashCode => Object.hash(runtimeType,selectedProject,const DeepCollectionEquality().hash(projects));

@override
String toString() {
  return 'ProjectsState(selectedProject: $selectedProject, projects: $projects)';
}
...
@useResult
$Res call({
 Project selectedProject, List<Project> projects
});
...
/// Create a copy of ProjectsState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? selectedProject = null,Object? projects = null,}) {
  return _then(_self.copyWith(
selectedProject: null == selectedProject ? _self.selectedProject : selectedProject // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Project selectedProject,  List<Project> projects)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectsState() when $default != null:
return $default(_that.selectedProject,_that.projects);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( Project selectedProject,  List<Project> projects)  $default,) {final _that = this;
switch (_that) {
case _ProjectsState():
return $default(_that.selectedProject,_that.projects);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( Project selectedProject,  List<Project> projects)?  $default,) {final _that = this;
switch (_that) {
case _ProjectsState() when $default != null:
return $default(_that.selectedProject,_that.projects);case _:
  return null;
...
class _ProjectsState implements ProjectsState {
  const _ProjectsState({this.selectedProject = const Project(), final  List<Project> projects = const []}): _projects = projects;
  

@override@JsonKey() final  Project selectedProject;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ProjectsState&&(identical(other.selectedProject, selectedProject) || other.selectedProject == selectedProject)&&const DeepCollectionEquality().equals(other._projects, _projects));
}


@override
int get hashCode => Object.hash(runtimeType,selectedProject,const DeepCollectionEquality().hash(_projects));
...
@override $ProjectCopyWith<$Res> get selectedProject;
...
/// Create a copy of ProjectsState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? selectedProject = null,Object? projects = null,}) {
